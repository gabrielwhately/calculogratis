...
export function SalarioLiquidoForm() {
  ...
  return (
    <>
      <FormCard>
        <Input label="Salário bruto (R$)" id="salario" value={salario} onChange={setSalario} inputMode="decimal" placeholder="Ex: 5.000,00" />
        <Input label="Número de dependentes" id="dependentes" value={dependentes} onChange={setDependentes} inputMode="numeric" placeholder="0" />
