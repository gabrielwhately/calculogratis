  ...
  return (
    <>
      <FormCard>
        ...
        <Input label="Anos de contribuição" id="anos" value={anos} onChange={setAnos} inputMode="numeric" placeholder="Ex: 20" />
        <Input label="Média salarial (R$)" id="media" value={media} onChange={setMedia} inputMode="decimal" placeholder="Ex: 4.000,00" />
