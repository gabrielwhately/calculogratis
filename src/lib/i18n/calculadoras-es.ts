...
const CALCULADORAS_ES: Record<string, CalculadoraI18n> = {
  'rescisao': { nome: 'Liquidación Laboral', descricao: 'Calcule el valor de su liquidación laboral. Simule despido sin justa causa, renuncia y acuerdo.', keywords: 'liquidación laboral, cálculo liquidación, despido, indemnización, finiquito' },
  ...
  'vale-transporte': { nome: 'Vale-Transporte', descricao: 'Calcule el descuento de vale-transporte en su salario (Tablas 2026). Descubra cuánto debe pagar la empresa.', keywords: 'vale-transporte, cálculo VT, descuento transporte, beneficio transporte' },
  ...
  'conversor-taxas': { nome: 'Conversor de Tasas', descricao: 'Convierta tasas de interés entre períodos: diaria, mensual y anual.', keywords: 'conversor tasas interés, tasa mensual a anual, tasa equivalente, tipo de interés' },
  ...
  'markup': { nome: 'Markup', descricao: 'Calcule el precio de venta ideal a partir del costo del producto.', keywords: 'calculadora markup, margen de ganancia, precio de venta, utilidad' },
  ...
  'aposentadoria': { nome: 'Jubilación', descricao: 'Simule su jubilación. Calcule tiempo de contribución e valor estimado.', keywords: 'jubilación, cálculo jubilación, previsión social' },
  ...
  'gestacional': { nome: 'Calculadora Gestacional', descricao: 'Calcule la edad gestacional y fecha probable de parto.', keywords: 'calculadora gestacional, fecha probable parto, semanas de gestación, embarazo' },
  ...
  'custas-processuais': { nome: 'Costas Procesales', descricao: 'Estime el valor de las costas procesales iniciales de una acción judicial en Brasil.', keywords: 'costas procesales, cálculo costas, tasa judicial, valor de la causa' },
