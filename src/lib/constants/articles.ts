...
export const ARTICULOS_ES: Record<string, ArticleContent> = {
  ...
  "guia-regla-de-tres": {
    ...
    content: [
      ...
      "Se utiliza cuando tenemos solo dos magnitudes. Puede ser Directa (cuando una aumenta, la otra también) o Inversa (cuando una aumenta, la otra disminuye).",
      "### Paso a Paso",
  ...
  "porcentaje-guia-rapida": {
    ...
    content: [
      ...
      "2. **Descuento**: Multiplique por (1 - tasa). Ej: descuento del 15% -> valor * 0.85.",
