...
export default function SugerirPageES() {
  ...
  return (
    <div className="container-app py-12 max-w-2xl">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-navy dark:text-white mb-4">{I18N.title}</h1>
        <p className="text-slate-600 dark:text-slate-400">{I18N.description}</p>
      </div>
      ...
      {status === 'success' ? (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl p-8 text-center">
          ...
          <p className="text-green-800 dark:text-green-200 font-medium mb-6">{I18N.success}</p>
          <Link href="/es" className="inline-flex items-center text-accent font-bold hover:underline">
            {I18N.back}
          </Link>
        </div>
      ) : (
