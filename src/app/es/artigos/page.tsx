...
export const metadata: Metadata = {
  title: "Artículos y Consejos Financieros | Cálculo Grátis",
...
const ARTIGOS = [
  {
    ...
    category: "Laboral",
    readTime: "5 min",
    tags: ["Liquidación", "Finiquito", "Legal"]
  },
  {
        ...
        {ARTIGOS.map((art, i) => (
          <article key={i} className="group flex flex-col bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden hover:shadow-xl hover:border-accent/30 transition-all duration-300">
            <div className="p-8">
              ...
              <Link href={`/es/artigos/${art.slug}`} className="mt-auto inline-flex items-center gap-2 text-accent font-bold group-hover:translate-x-1 transition-transform">
                Leer guía completa
