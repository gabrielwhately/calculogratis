      ...
      <section className="grid gap-6 md:grid-cols-3">
        <Link href="/favoritos" className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 hover:border-red-200 dark:hover:border-red-900/30 transition-all shadow-sm">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Ferramentas que você favoritou.</p>
            </div>
          </div>
        </Link>
        <Link href="/historico" className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 hover:border-blue-200 dark:hover:border-blue-900/30 transition-all shadow-sm">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              <h3 className="font-bold text-navy dark:text-white group-hover:text-blue-500 transition-colors">Histórico</h3>
              <p className="text-xs text-slate-500">Resultados que você salvou.</p>
            </div>
          </div>
        </Link>
        <Link href="/widgets" className="group p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 hover:border-accent/30 transition-all shadow-sm">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              <h3 className="font-bold text-navy dark:text-white group-hover:text-accent transition-colors">Para Parceiros</h3>
              <p className="text-xs text-slate-500">Calculadoras para o seu site.</p>
            </div>
          </div>
        </Link>
      </section>
